...
public class PayUMoneyActivity extends AppCompatActivity {
    private final String TAG=PayUMoneyActivity.class.getSimpleName();
    WebView webView;
    ...
    */
    ...
    // Final Variables
    private String mMerchantKey = "1ywPdvsT";
    private String mSalt = "5cxJUk4F0f";
...
//            isFromOrder = bundle.getBoolean("isFromOrder");
        ...
        mFirstName ="Anas";
        mEmailId = "anasmansoori734@gmail.com";
        mAmount = 10;
        mPhone = "8081031624";
        mId = 7199892;
        isFromOrder = true;
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.equals(mSuccessUrl)) {
                        Log.e(TAG, "onSuccess : true :: "+mTXNId+" :: "+mId+" :: "+isFromOrder );
...
//                        startActivity(intent);
                        ...
                        Log.e(TAG, "onSuccess : false :: "+mTXNId+" :: "+mId+" :: "+isFromOrder );
//                        Intent intent = new Intent(PayUMoneyActivity.this, PaymentStatusActivity.class);
...
//            webView.getSettings().setCacheMode(Cache.NONE);

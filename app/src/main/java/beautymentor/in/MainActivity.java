...
//            fm.setArguments(args);
    ...
    public void shareApp() {
        ...
        String lnk=Home_fragment.app_link;
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Hi friends i am using " +lnk+ " APP");
    ...
    private void showSnack(boolean isConnected) {
        ...
        if (!isConnected) {
            Intent intent = new Intent(MainActivity.this, No_intenet_Activity.class);
            startActivity(intent);
        }
    }
